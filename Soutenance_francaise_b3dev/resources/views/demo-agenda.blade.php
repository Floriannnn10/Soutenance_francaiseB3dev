<x-app-layout>
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <!-- En-tête -->
            <div class="mb-8">
                <h1 class="text-3xl font-bold text-gray-900 mb-2">📅 Démonstration de l'Agenda</h1>
                <p class="text-gray-600">Interface moderne avec calendrier, liste des cours et cours récents</p>
            </div>
                ...
                <div class="bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg p-6 text-white">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold">{{ \App\Models\SessionDeCours::where('start_time', '>', now())->count() }}</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-lg font-bold">
                                @php
                                    $prochainCours = \App\Models\SessionDeCours::where('start_time', '>', now())->orderBy('start_time')->first();
                                @endphp
                                @if($prochainCours)
                                    {{ $prochainCours->start_time->format('d/m H:i') }}
                                @else
                                    Aucun
                                @endif
                            </p>
            ...
            <div id="content-liste" class="tab-content hidden">
                ...
                <div class="bg-white rounded-lg shadow-lg p-6">
                    <h2 class="text-xl font-semibold text-gray-900 mb-6">📚 Cours à venir</h2>

                    @php
                        $sessionsFutures = \App\Models\SessionDeCours::with(['matiere', 'classe', 'enseignant'])
                                ...
                                <div class="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
                                    <div class="flex items-center justify-between">
                                        <div class="flex-1">
                                            ...
                                            <p class="text-gray-600">{{ $session->classe->nom }} - {{ $session->typeCours->nom ?? 'Présentiel' }}</p>
            ...
            <div id="content-recent" class="tab-content hidden">
                ...
                <div class="bg-white rounded-lg shadow-lg p-6">
                    ...
                    @php
                        $sessionsRecentes = \App\Models\SessionDeCours::with(['matiere', 'classe', 'enseignant'])
                            ->where('start_time', '<=', now())
            ...
            <div class="mt-8 p-4 bg-blue-50 rounded-lg">
                <h3 class="text-lg font-semibold text-blue-900 mb-2">📝 Instructions de test</h3>
                <ul class="list-disc list-inside space-y-1 text-blue-800">
                    <li>Cliquez sur les onglets pour naviguer entre les vues</li>
                    <li>Utilisez les flèches du calendrier pour changer de mois</li>
                    <li>Les cours sont affichés avec des couleurs différentes selon leur statut</li>
                    <li>Cette démonstration utilise les données de test créées</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        @php
            $sessions = \App\Models\SessionDeCours::with(['matiere', 'classe'])->get();
            $sessionsParMois = [];
        ...
        @endphp
        sessionsData = @json($sessionsParMois);
