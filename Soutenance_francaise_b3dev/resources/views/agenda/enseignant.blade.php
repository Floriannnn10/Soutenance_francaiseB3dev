    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                ...
                <p class="text-gray-600">Bienvenue {{ $enseignant->prenom }} {{ $enseignant->nom }} - Enseignant</p>
            </div>
            ...
            <div id="content-calendrier" class="tab-content">
                ...
                <div class="bg-white rounded-lg shadow-lg p-6">
                    <div class="flex justify-between items-center mb-6">
                        <h2 class="text-xl font-semibold text-gray-900">Calendrier de mes cours</h2>
                ...
                <div class="bg-white rounded-lg shadow-lg p-6">
                    ...
                    @else
                        <div class="text-center py-8">
                            ...
                            <p class="mt-1 text-sm text-gray-500">Aucun cours n'a été enseigné récemment.</p>
                        </div>
                    @endif
                </div>
            </div>
        ...
        function generateCalendar() {
            ...
            for (let i = 0; i < 42; i++) {
                ...
                sessionsForDay.forEach(session => {
                    ...
                    sessionElement.className = 'text-xs p-1 mb-1 rounded bg-green-100 text-green-800 truncate';
